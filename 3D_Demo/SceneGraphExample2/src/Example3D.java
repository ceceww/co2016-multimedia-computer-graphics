/**
 * Describe class (scene graph example 2) Example3D here.
 *
 * Time-stamp: <2017-02-10 18:55:42 rlc3> edited by rlc 
 *
 *
 */
...
public class Example3D extends JFrame {
	...
	// What does this do? yAxis.rotZ(-Math.PI/2); 
        ...
        RotationInterpolator rotatorcubeTG2 = new RotationInterpolator(rotationAlphacubeTG2,
